...
class VragenController extends Cms {
    ...
    public function editAction() {
        ...
        $form = $this->view->form = new VragenForm($this->_getParam('id',false));
    ...
    public function deleteAction() {
        ...
        $q_delete = $this->_db->prepare('DELETE FROM questions WHERE id = :id');
